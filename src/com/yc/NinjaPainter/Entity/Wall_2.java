...
public class Wall_2 extends Wall{
	...
	protected void loadResources(){
		...
		this.mWall = ((BaseActivity)this.context).createTR(this.mBitmapTexture, "wall_left_bottom_"+((GameActivity)this.context).getStage()+".png", 0, 0);
	...
	public boolean check(Player mPlayer) {
		if(mPlayer.getDirection()==Constant.DOWN || mPlayer.getDirection()==Constant.LEFT){
			return true;
		}
		return false;
	};
