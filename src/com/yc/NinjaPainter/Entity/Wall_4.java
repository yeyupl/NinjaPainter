...
public class Wall_4 extends Wall{
	...
	protected void loadResources(){
		...
		this.mWall = ((BaseActivity)this.context).createTR(this.mBitmapTexture, "wall_right_top_"+((GameActivity)this.context).getStage()+".png", 0, 0);
	...
	public boolean check(Player mPlayer) {
		if(mPlayer.getDirection()==Constant.RIGHT || mPlayer.getDirection()==Constant.UP){
			return true;
		}
		return false;
	};
